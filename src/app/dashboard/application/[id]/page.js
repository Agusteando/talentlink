...
export default async function ApplicationDetail({ params }) {
  ...
  // Fetch Checklist Configuration (Templates) ordered by sortOrder
        ...
        <div className="flex gap-3 items-center">
          ...
          {app.cvUrl && (
            <a
              href={app.cvUrl}
              download
              className="flex items-center gap-2 px-4 py-2 bg-slate-800 text-white rounded-lg text-sm font-bold hover:bg-slate-900 transition shadow-sm"
            >
