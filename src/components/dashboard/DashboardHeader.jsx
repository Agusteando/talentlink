    ...
    <header className="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-sm">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 select-none">
          <div className="h-8 w-8 bg-slate-900 text-white rounded-lg flex items-center justify-center font-bold text-lg">
            T
          </div>
          <span className="font-bold text-slate-800 hidden lg:block tracking-tight">
            TalentLink
          </span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          {(can(PERMISSIONS.MANAGE_CONFIG) || can(PERMISSIONS.MANAGE_USERS)) && (
            <Link
              ...
              className="p-2 rounded-lg text-slate-400 hover:text-blue-600 hover:bg-slate-50"
              title="Configuración"
            >
              <Settings size={18} />
            </Link>
