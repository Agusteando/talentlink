...
export default function Header() {
  ...
  useEffect(() => {
    // Debug: Validate session state rendering in Header
    // This helps confirm why logout/dash isn't shown
    console.debug('[Header] session status:', status, 'email:', session?.user?.email || 'none');
  ...
  // Show Dashboard button only when authenticated and with dashboard access signals
